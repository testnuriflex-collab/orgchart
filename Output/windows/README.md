...
4. 압축을 풀면 `START-Windows/` 폴더 안에 `OrgChartStudio.exe`가 있습니다.
...
xcopy /E /I dist\START-Windows "..\..\START-Windows"
```

`dev\dist\START-Windows\OrgChartStudio.exe` 가 생성되고, 최상위 `START-Windows/` 폴더에 복사됩니다.
