...
4. 압축을 풀면 `start_windows/` 폴더 안에 `OrgChartStudio.exe`가 있습니다.
...
xcopy /E /I dist\start_windows "..\..\start_windows"
```

`dev\dist\start_windows\OrgChartStudio.exe` 가 생성되고, 최상위 `start_windows/` 폴더에 복사됩니다.
